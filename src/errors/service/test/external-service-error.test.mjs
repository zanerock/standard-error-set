...
describe('ExternalServiceError', () => {
  ...
  const testData = [
    ...
    [{ service : 'Foo API' }, /^There was an error with the remote Foo API service.$/],
    [{ issue : 'is not responding' }, /^The remote service is not responding\./,],
    [{ service : 'Foo API', issue : 'is not responding' }, /^The remote Foo API service is not responding\./,],
    [
