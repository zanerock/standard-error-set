...
describe('UnavailableError', () => {
  ...
  test.each([
    [undefined, /The target resource is currently unavailable./, 500, undefined],
    ...
    [{ target : 'customer db', issue : 'off line for maintenance', expectedTime : 'after 2:00', status : 400, cause : causeError }, /The customer db is off line for maintenance; try again after 2:00./, 400, causeError],
