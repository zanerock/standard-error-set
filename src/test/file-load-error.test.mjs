...
describe('FileLoadError', () => {
  ...
  const testData = [
    ...
    [{ fileName : 'foo.txt' }, /There was an error loading the file 'foo\.txt'./],
    [{ dirPath : '/bar', fileName : 'foo.txt' }, /There was an error loading the file '\/bar\/foo\.txt'./],
    [{ dirPath : '/bar', issue : 'virtual socket closed' }, /There was an error loading the file in directory '\/bar'; virtual socket closed./],
