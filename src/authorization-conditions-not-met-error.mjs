/* globals AuthenticationRequiredError NoAccessError OperationNotPermittedError */ // used in the docs
...
const AuthorizationConditionsNotMetError = class extends AuthError {
   ...
   * @param {string|undefined} hint - A description of what the user might do to remedy the situation. This should be a 
   *   complete sentence. E.g., 'You may contact customer service and request a quota increase.', or 'Try again in a 
   *   few minutes.'
   * @param {string|undefined} issue - A description of the problem. E.g., 'the user is over request quota', or 'this 
   *   operation is only allowed between 0900 and 1700'.
   * @example
